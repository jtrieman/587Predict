...
branch_preds = ["taken", "nottaken", "bimod", "tage"]
...
sim_bpred_cmd = '../Run.pl -db ../bench.db -dir ../results/{}_{} -benchmark {} -sim {}sim-bpred -args \"-bpred {} \" > ../results/project/{}_{}.out 2>&1'
...
for benchmark in benchmarks:
    for branch_pred in branch_preds:
        ...
        os.system(sim_bpred_cmd.format(benchmark, branch_pred, benchmark, simulator_loc, branch_pred, benchmark, branch_pred))
        print ("Executing: " + sim_bpred_cmd.format(benchmark, branch_pred, benchmark, simulator_loc, branch_pred, benchmark, branch_pred))
